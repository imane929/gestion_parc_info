...
@section('page-title', 'Schedule Preventive Maintenance')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                ...
                                <option value="nettoyage" {{ old('type') == 'nettoyage' ? 'selected' : '' }}>Cleaning</option>
                                <option value="verification" {{ old('type') == 'verification' ? 'selected' : '' }}>Verification</option>
                                <option value="mise_a_jour" {{ old('type') == 'mise_a_jour' ? 'selected' : '' }}>Update</option>
                                <option value="remplacement" {{ old('type') == 'remplacement' ? 'selected' : '' }}>Replacement</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="statut" class="form-select @error('statut') is-invalid @enderror" required>
                                <option value="planifie" {{ old('statut', 'planifie') == 'planifie' ? 'selected' : '' }}>Scheduled</option>
                                <option value="en_cours" {{ old('statut') == 'en_cours' ? 'selected' : '' }}>In Progress</option>
                                <option value="termine" {{ old('statut') == 'termine' ? 'selected' : '' }}>Completed</option>
                                <option value="annule" {{ old('statut') == 'annule' ? 'selected' : '' }}>Cancelled</option>
                            </select>
                            @error('statut')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
