...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.licences.update', $licence) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="logiciel_id" class="form-select select2 @error('logiciel_id') is-invalid @enderror" required>
                                ...
                                @foreach(\App\Models\Logiciel::all() as $logiciel)
                                    <option value="{{ $logiciel->id }}" {{ old('logiciel_id', $licence->logiciel_id) == $logiciel->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="cle_licence" class="form-control @error('cle_licence') is-invalid @enderror" 
                                   value="{{ old('cle_licence', $licence->cle_licence) }}" required>
                            @error('cle_licence')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date_achat" class="form-control @error('date_achat') is-invalid @enderror" 
                                   value="{{ old('date_achat', $licence->date_achat->format('Y-m-d')) }}" required>
                            @error('date_achat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date_expiration" class="form-control @error('date_expiration') is-invalid @enderror" 
                                   value="{{ old('date_expiration', $licence->date_expiration->format('Y-m-d')) }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="nb_postes" class="form-control @error('nb_postes') is-invalid @enderror" 
                                   value="{{ old('nb_postes', $licence->nb_postes) }}" min="1" required>
                            @error('nb_postes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="notes" class="form-control" rows="4">{{ old('notes', $licence->notes ?? '') }}</textarea>
                        </div>
