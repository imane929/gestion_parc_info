                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="montant" class="form-control @error('montant') is-invalid @enderror" 
                                       value="{{ old('montant') }}" step="0.01" min="0">
                            </div>
                            @error('montant')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="renouvellement_auto" value="1" {{ old('renouvellement_auto') ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="jours_alerte" class="form-control @error('jours_alerte') is-invalid @enderror" 
                                   value="{{ old('jours_alerte', 30) }}" min="1">
                            @error('jours_alerte')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="sla" class="form-control @error('sla') is-invalid @enderror" 
                                      rows="5">{{ old('sla') }}</textarea>
                            @error('sla')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">
                                Describe the service level agreement: response times, resolution times, availability, etc.
                            </small>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{ route('admin.contrats.index') }}" class="btn btn-outline-secondary">
